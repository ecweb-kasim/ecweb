            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar">
                ...
                <div class="offcanvas-body">
                    <ul id="navbar" class="navbar-nav fw-bold justify-content-end align-items-center flex-grow-1">
                        ...
                        <li class="nav-item">
                            <select id="headerCategoryFilter" name="header_category" onchange="filterHeaderCategory()" class="nav-link me-5 p-0 border-0 bg-transparent">
...
<script>
    ...
    // Function to filter categories from header
    function filterHeaderCategory() {
        const category = document.getElementById('headerCategoryFilter').value;
        if (category) {
            window.location.href = '../pages/shop.php?category=' + encodeURIComponent(category);
        } else {
            window.location.href = '../pages/shop.php'; // Redirect to shop page without category filter
        }
    }
</script>
