    ...
    <section class="product-store">
        <div class="container-md">
            <div class="display-header d-flex align-items-center justify-content-between">
                <h2 class="section-title text-uppercase">Men Products</h2>
                <div class="btn-right">
                    <a href="shop.php?category=Men" class="d-inline-block text-uppercase text-hover fw-bold">View all</a>
                </div>
            </div>
            <div class="product-content padding-small">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5" id="productList">
                    ...
                    try {
                        ...
                        if (empty($products)) {
                            echo '<div class="no-products">No men\'s products available.</div>';
                        } else {
                            foreach ($products as $index => $product) {
                                ...
                                echo '<h3 class="card-title fs-6 fw-normal m-0"><a href="men.php?id=' . $product['id'] . '">' . htmlspecialchars($product['title']) . '</a></h3>';
